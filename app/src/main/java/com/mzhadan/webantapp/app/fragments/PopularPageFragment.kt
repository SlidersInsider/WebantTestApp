...
class PopularPageFragment(containerFragmentManager: FragmentManager) : Fragment() {
    ...
    override fun onCreateView(
        ...
        var view: View = inflater.inflate(R.layout.popular_page_fragment, container, false)

        recyclerView = view.findViewById(R.id.popularPageRecyclerView)
        recyclerView.layoutManager = GridLayoutManager(view.context, 2)
        swipeRefreshLayout = view.findViewById(R.id.popularPageSwipeRefreshLayout)
        progressBar = view.findViewById(R.id.popularPageProgressBar)
        nestedScrollView = view.findViewById(R.id.popularPageNestedScrollView)
    ...
    fun loadData(webantApi: WebantApi){
        compositeDisposable.add(webantApi
            .getPopularImages(imageLimit, true, page)
